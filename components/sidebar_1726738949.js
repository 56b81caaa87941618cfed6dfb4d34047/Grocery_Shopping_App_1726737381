        ...
        <div>
          ...
          <div class="py-4 px-4 w-fit border-t border-black">
            <div class="flex items-center gap-x-4">
              <div>
                <span class="block text-white-700 text-sm font-semibold">Shop smarter, not harder</span>
                <a href="javascript:void(0)" class="block mt-px text-white-600 text-xs">Let's make your grocery run a breeze!</a>
              </div>
            </div>
          </div>
        </div>
