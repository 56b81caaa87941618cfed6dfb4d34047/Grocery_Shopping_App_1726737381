...
<template>
  <footer id="footer-section-container" style="min-height: 110px">
...
<script>
export default {
  name: "dark_footer_component_1726738241",
  data() {
    return {
      expanded: false,
      tab: null,
